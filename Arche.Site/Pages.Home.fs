    ...
    module Client =
        ...
        let page() = divAttr [ attr.``class`` "jumbotron" ] 
                             [ h1 [ text "Hi "; iAttr [ attr.``class`` "fa fa-smile-o" ] [] ]
                               p  [ text "Arche is a simple app built in F# with WebSharper where I demonstrate one way to structure a web app."
                                    br []
                                    text "This web app is explained in details on my blog post "; aAttr [ attr.href "#" ] [ text "link" ]; text "."
                                    br [] 
                                    text "You can find the code "; aAttr [ attr.href "https://github.com/Kimserey/Arche" ] [ text "on github" ]; text "." ]
